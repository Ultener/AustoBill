...
interface AuthCtx {
  ...
  register: (username: string, email: string, password: string, ref?: string) => Promise<string | null>;
  logout: () => void;
...
function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const register = async (username: string, email: string, password: string, ref?: string): Promise<string | null> => {
    try {
      await authApi.register(username, email, password, undefined, ref);
      return null;
    } catch (e) {
